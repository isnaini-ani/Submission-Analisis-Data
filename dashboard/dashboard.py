...
main_data = pd.read_csv(r"C:\Users\isnai\proyek_analisis_data\submission\dashboard\main_data.csv")
...
with st.sidebar:
    ...
    st.image(r"C:\Users\isnai\proyek_analisis_data\submission\dashboard\logo.png")
